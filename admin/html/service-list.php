                            ...
                            <div class="nk-content-body">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <li class="nk-block-tools-opt">
                                                            ...
                                                            <a href="#" data-target="addProduct" class="toggle btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Services</span></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $database = mysqli_query($connection, "SELECT * FROM services");
                                                            ...
                                                            <ul class="nk-tb-actions gx-1 my-n1">
                                                                <li class="me-n1">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li><a href="html/edit-service-list.php?ID=<?php echo $id; ?>"><em class="icon ni ni-edit"></em><span>Edit Product</span></a></li>
                                ...
                                <div class="nk-add-product toggle-slide toggle-slide-right" data-content="addProduct" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar>
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h5 class="nk-block-title">New Services</h5>
                                            <div class="nk-block-des">
                                                <p>Add information and add new services.</p>
                                            </div>
                                        </div>
                                    </div><!-- .nk-block-head -->
                                    <div class="nk-block">
                                        <div class="row g-3">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="product-title">Services Name</label>
                                                    <div class="form-control-wrap">

<?php 
    ...
    $locate = $_SERVER['DOCUMENT_ROOT'] . "\connection.php";
    require_once($locate);
    ...
    if(isset($_POST['submit'])) {
        ...
        echo "TESTED";
        $database = mysqli_query($connection, "INSERT INTO admin(Name, Email, Username, Password) values('$name', '$email', '$username', '$password')");

        if($database) {
            header("Location: pages/auths/register-success.php");
        }
    }
                                ...
                                <form method="POST">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" name="fullname" class="form-control form-control-lg" id="name" placeholder="Enter your name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="password">Re-type Passcode</label>
                                        <div class="form-control-wrap">
                                            <input type="password" name="password" class="form-control form-control-lg" id="password2" placeholder="Re-type your passcode">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="custom-control custom-control-xs custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="checkbox">
                                            <label class="custom-control-label" for="checkbox">I agree to Laundrybest <a href="#">Privacy Policy</a> &amp; <a href="#"> Terms.</a></label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <button id="button" name="submit" class="btn btn-lg btn-block text-white" style="background: #816bff;">Register</button>
                                    </div>
                                </form>

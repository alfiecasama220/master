<?php 
    ...
    // if(isset($_GET['ID'])) {
    //     $getID = $_GET['ID'];
    //     $delete = mysqli_query($connection, "DELETE FROM inventory WHERE id = '$getID'");
                        ...
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $database = mysqli_query($connection, "SELECT * FROM admin");
                                                    ...
                                                    <div class="nk-tb-item">
                                                        ...
                                                        <div class="nk-tb-col">
                                                            <span class="tb-sub"><?php echo $email; ?></span>
                                                        </div>
                                                        <!-- <div class="nk-tb-col">
                                                            <span class="tb-lead">$ 29.00</span>
                                                        </div> -->
                                                        <div class="nk-tb-col">
                                                            <span class="tb-sub"><?php echo $username; ?></span>
                                                        </div>
                                                        <div class="nk-tb-col">
                                                            <span class="tb-sub"><?php echo str_replace($password, "**************", "$password") ?></span>
                                                        </div>
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $database = mysqli_query($connection, "SELECT * FROM staff");
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Manager</h3>
                                        </div><!-- .nk-block-head-content -->
                                        <div class="nk-block-head-content">
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                <a href="#" class="btn btn-icon btn-trigger toggle-expand me-n1" data-target="pageMenu"><em class="icon ni ni-more-v"></em></a>
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $database = mysqli_query($connection, "SELECT * FROM manager");
                                            ...
                                            <div class="card-inner p-0">
                                                <div class="nk-tb-list">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $database = mysqli_query($connection, "SELECT * FROM client");

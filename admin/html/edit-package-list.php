<?php 
    ...
    if(isset($_POST['edit'])) {
        ...
        $database = mysqli_query($connection, "UPDATE package SET Title = '$name', Category= '$category', Description ='$description', Price = '$price' WHERE id = '$getID'");
        if($database) {
            header("Location: package-list.php?success=true");
        }
    }
    ...
    $data = mysqli_query($connection, "SELECT * FROM package WHERE id = '$getID'");
                                            ...
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="category" id="sKU" placeholder="Category" value="<?php echo $category; ?>">
                                                    </div>
                                                </div><!--col-->    
                                                <div class="col-xxl-3 col-md-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="form-group">    <label class="form-label" for="customFileLabel">Default File Upload</label>    <div class="form-control-wrap">        <div class="form-file">            <input type="file" class="form-file-input" name="image" id="customFile" value="<?php echo $image; ?>">            <label class="form-file-label" for="customFile">Choose file</label></div></div>
                                                </div>

...
<header id="header" class="header header-layout-type-header-2rows">
    <div class="header-top" style="background: #6f42c1;">
      <div class="container">
        <div class="row">
          <div class="col-xl-auto header-top-left align-self-center text-center text-xl-left">
            <ul class="element contact-info">
              <li class="contact-phone"><i class="fa fa-phone font-icon sm-display-block"></i> Tel: +63 998 4489 709</li>
              <li class="contact-email"><i class="fa fa-envelope font-icon sm-display-block"></i> laundrybest@gmail.com</li>
              <li class="contact-address"><i class="fa fa-map font-icon sm-display-block"></i>Lapu-lapu Street, North Poblacion, Bacong Negros Oriental</li>
            </ul>
          </div>
          <div class="col-xl-auto ml-xl-auto header-top-right align-self-center text-center text-xl-right">
            <!-- <div class="element pt-0 pb-0">
              <ul class="styled-icons icon-dark icon-theme-colored1 icon-circled clearfix">
                <li><a style="background: #6f42c1;" href="#" ><i class="fab fa-facebook"></i></a></li>
                <li><a style="background: #6f42c1;" href="#" ><i class="fab fa-twitter"></i></a></li>
                <li><a style="background: #6f42c1;" href="#" ><i class="fab fa-youtube"></i></a></li>
              </ul>
            </div>
            <div class="element pt-0 pb-0">
          ...
          <div class="container position-relative">
            <div class="row header-nav-col-row">
              <div class="col-sm-auto align-self-center">
                <a class="menuzord-brand site-brand" href="<?php echo dirname($_SERVER['HTTP_HOST']); ?>">
                ...
                <nav id="top-primary-nav" class="menuzord green" data-effect="slide" data-animation="none" data-align="right">
                  <ul id="main-nav" class="menuzord-menu">
                    <li class="active menu-item">
                      <a href="<?php echo dirname($_SERVER['HTTP_HOST']); ?>">Home</a>
                    </li>
                    ...
                    <?php 
                        ...
                        if(isset($_SESSION['logged']) == false) {
                            echo '<li class="menu-item"><a href="login.php">Login</a>';
                        } else {
                            echo '<li class="menu-item"><a href="logout.php">Logout</a>';
                        }
                    ...
                    if(isset($_SESSION['logged'])) {
                        ...
                        <div class="top-nav-mini-cart-icon-container">
                          <div class="top-nav-mini-cart-icon-contents">
                            <a class="mini-cart-icon" href="shop-cart.php" title="View your shopping cart">

<!-- Footer -->
<footer id="footer" class="footer layer-overlay overlay-dark-9" data-tm-bg-img="img/bg-img.png">
          ...
          <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="widget">
              ...
              <div class="opening-hours border-dark">
                <ul>
                  <li class="clearfix"> <span> Monday - Sunday :  </span>
                    <div class="value pull-right flip"> 09.00 am - 7.00 pm </div>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="row pt-20 pb-20">
            <div class="col-sm d-flex justify-content-center align-items-center">
              <div class="footer-paragraph">
                © 2020 laundrybest. All Rights Reserved.
              </div>
            </div>

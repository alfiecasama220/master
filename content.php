                        ...
                        <div class="isotope-item cat1 cat3">
                            ...
                            <div class="product">
                                ...
                                <div class="thumb image-swap">
                                    <a href="transaction.php?ID=<?php echo $id; ?>"><img src="packages/<?php echo $image; ?>" class="product-main-image img-responsive img-fullwidth" width="300" height="300" alt="product"></a>
                                    <a href="transactionw.php?ID=<?php echo $id; ?>"><img src="packages/<?php echo $image; ?>" class="product-hover-image img-responsive img-fullwidth" alt="product"></a>
                                </div>
